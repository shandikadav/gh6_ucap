...
class CommunityRepository {
  ...
  Future<List<ForumQuestion>> fetchForumQuestions() async {
    try {
      ...
      return snapshot.docs.map((doc) => ForumQuestion.fromFirestore(doc)).toList();
    } catch (e) {
  ...
  List<ForumQuestion> _getSampleQuestions() {
    return [
      ForumQuestion(
        ...
        content: 'Aku baru lulus dan dapat tawaran kerja. Tapi gajinya di bawah ekspektasi. Boleh ga sih nego gaji? Takut malah ditolak...',
        authorName: 'Anonim',
        isAnonymous: true,
        replyCount: 12,
      ...
      ForumQuestion(
        ...
        content: 'Ada yang pernah ngalamin diperlakukan beda karena background kita? Gimana cara ngatasinya ya?',
        authorName: 'Anonim',
        isAnonymous: true,
        replyCount: 8,
      ...
      ForumQuestion(
        ...
        content: 'Lagi cari kos di area Jakarta Selatan budget 1-1.5 juta. Ada yang punya rekomendasi?',
        authorName: 'Sarah M.',
        isAnonymous: false,
        replyCount: 15,
      ...
      ForumQuestion(
        ...
        content: 'Saya kuliah sambil kerja part-time. Tapi akhir-akhir ini susah banget manage waktunya. Ada tips?',
        authorName: 'Budi P.',
        isAnonymous: false,
        replyCount: 6,
  ...
  List<Mentor> _getSampleMentors() {
    return [
      Mentor(
        ...
        bio: 'HR Manager dengan 10+ tahun pengalaman di berbagai industri. Spesialis career development untuk fresh graduate.',
        profilePictureUrl: '',
        isOnline: true,
        skills: ['Review CV', 'Interview Prep', 'Career Planning', 'Salary Negotiation'],
      ),
      Mentor(
        id: 'sample_mentor_2',
        name: 'Sarah Wijaya',
        title: 'Financial Planner',
        bio: 'Certified Financial Planner dengan fokus membantu young professional mengelola keuangan.',
        profilePictureUrl: '',
        isOnline: false,
        skills: ['Budgeting', 'Investment', 'Financial Planning', 'Debt Management'],
      ),
      Mentor(
        id: 'sample_mentor_3',
        name: 'Rendi Pratama',
        title: 'Corporate Trainer',
        bio: 'Corporate Trainer & Life Coach yang berpengalaman 8 tahun mengembangkan soft skills profesional.',
        profilePictureUrl: '',
        isOnline: true,
        skills: ['Communication', 'Leadership', 'Public Speaking', 'Team Management'],
      ),
      Mentor(
        id: 'sample_mentor_4',
        name: 'Dewi Lestari',
        title: 'Psychologist',
        bio: 'Psikolog klinis yang membantu mengatasi stress kerja dan masalah mental health di workplace.',
        profilePictureUrl: '',
        isOnline: true,
        skills: ['Mental Health', 'Stress Management', 'Work-Life Balance', 'Counseling'],
      ),
      Mentor(
        id: 'sample_mentor_5',
        name: 'Agus Rahman',
        title: 'Senior Software Engineer',
        bio: 'Senior developer dengan 12+ tahun pengalaman. Mentor untuk junior developer dan fresh graduate IT.',
        profilePictureUrl: '',
        isOnline: false,
  ...
  Future<void> createSampleData() async {
    try {
      ...
      final mentorsSnapshot = await _firestore.collection('mentors').limit(1).get();
